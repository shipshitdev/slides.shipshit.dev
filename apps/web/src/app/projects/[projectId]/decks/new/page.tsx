...
import { ArrowLeft, Loader2, Users, TrendingUp, Target, Presentation } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from "@/components/ui/card";
import { decksApi, setAuthHeader, type CreateDeckInput } from "@/lib/api";
...
function getDefaultSlides(audienceType: CreateDeckInput["audienceType"]) {
  ...
  switch (audienceType) {
    case "cold_leads":
      return [
        ...baseSlides,
        { id: "2", type: "content", data: { title: "The Hook", bullets: ["What makes you unique?", "Why should they care?"] } },
        { id: "3", type: "cta", data: { title: "Let's Talk", buttonText: "Schedule a Call" } },
      ];
    case "customers":
      return [
        ...baseSlides,
        { id: "2", type: "content", data: { title: "The Problem", bullets: ["Pain point 1", "Pain point 2"] } },
        { id: "3", type: "content", data: { title: "Our Solution", bullets: ["Feature 1", "Feature 2"] } },
        { id: "4", type: "stats", data: { title: "Results", stats: [{ value: "10x", label: "Faster" }] } },
        { id: "5", type: "cta", data: { title: "Get Started", buttonText: "Try Free" } },
      ];
    case "investors":
      return [
        ...baseSlides,
        { id: "2", type: "content", data: { title: "The Problem", bullets: ["Market gap", "Customer pain"] } },
        { id: "3", type: "content", data: { title: "Our Solution", bullets: ["Product overview"] } },
        { id: "4", type: "stats", data: { title: "Market Size", stats: [{ value: "$10B", label: "TAM" }] } },
        { id: "5", type: "stats", data: { title: "Traction", stats: [{ value: "100K", label: "Users" }] } },
        { id: "6", type: "team", data: { title: "Team", members: [] } },
        { id: "7", type: "content", data: { title: "The Ask", bullets: ["Raising $X", "Use of funds"] } },
      ];
    default:
      return baseSlides;
  }
